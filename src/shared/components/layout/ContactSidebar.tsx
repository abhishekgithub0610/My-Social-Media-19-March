"use client";
import { getAllUsers } from "@/helpers/data"; // to be cofirmed/deleted
import { useFetchData } from "@/useFetchData"; // to be cofirmed/deleted
    ...
    <div className="sidebar-end p-4 bg-mode custom-scrollbar h-100">
      <div className="sidebar-end-alignment d-flex justify-content-center flex-column">
        <div className="d-flex gap-2 align-items-center">
          <a
            className="btn p-0 text-secondary sidebar-end-toggle d-none d-lg-flex"
            onClick={toggle}
          >
            ...
            >
              ...
              <div className="contact-status ms-auto fs-3">
                {contact.status === "offline" ? (
                  <BsDot className="text-danger" />
                ) : (
                  <BsDot className="text-success" />
                )}{" "}
              </div>
            </li>
          ))}
