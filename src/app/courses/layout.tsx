...
import { coursePanelLinksData } from "@/assets/data/layout";
...
import CoursePanel from "@/shared/components/layout/CoursePanel";

const CourseLayout = ({ children }: ChildrenType) => {
              ...
              <nav className="navbar navbar-expand-lg mx-0">
                {width >= 992 ? (
                  <div className="d-block px-2 px-lg-0">
                    <CoursePanel links={coursePanelLinksData} />
                  </div>
                ) : (
                  <Offcanvas
            ...
            <div className="d-flex">
              ...
              <Dropdown>
                ...
                >
                  ...
                  <li>
                    <DropdownItem href="#">
                      <BsGear className="fa-fw pe-2" size={23} /> Chat
                      setting{" "}
                    </DropdownItem>
                  </li>
                  <li>
